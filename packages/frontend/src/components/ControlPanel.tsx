...
const ControlPanel: React.FC = () => {
    const { player1, setPlayer1, player2, setPlayer2, scores, setScores } = useScoreContext();
    ...
    const handleNameChange = (e: React.ChangeEvent<HTMLInputElement>, player: number) => {
    ...
    const handleCountryChange = (e: React.ChangeEvent<HTMLSelectElement>, player: number) => {
    ...
    const handleScoreChange = (boardIndex: number, playerIndex: number, increment: boolean) => {
        ...
        <div className="control-panel">
            <div className="player-info">
                ...
                <div>
                    <label>
                        Player 1 Name:
                        <input type="text" name="name" value={player1.name} onChange={(e) => handleNameChange(e, 1)} />
                    </label>
                    <label>
                        Country:
                        <select value={player1.country} onChange={(e) => handleCountryChange(e, 1)}>
                ...
                <div>
                    <label>
                        Player 2 Name:
                        <input type="text" name="name" value={player2.name} onChange={(e) => handleNameChange(e, 2)} />
                    </label>
                    <label>
                        Country:
                        <select value={player2.country} onChange={(e) => handleCountryChange(e, 2)}>
                            {Object.keys(countryCodes).map(countryName => (
                                <option key={countryCodes[countryName]} value={countryName}>
                                    {countryName}
                                </option>
                            ...
                            <div className="player">
                                ...
                                <div className="score-container">
                                    ...
                                    <div className="controls">
                                        <button onClick={() => handleScoreChange(boardIndex, 0, true)}>+</button>
                                        <button onClick={() => handleScoreChange(boardIndex, 0, false)}>-</button>
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div className="scoreboard-header">
                            <div className="player">
                                ...
                                <div className="score-container">
                                    ...
                                    <div className="controls">
                                        <button onClick={() => handleScoreChange(boardIndex, 1, true)}>+</button>
                                        <button onClick={() => handleScoreChange(boardIndex, 1, false)}>-</button>
                                    </div>
                                </div>
                            </div>
                        </div>
